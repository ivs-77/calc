...
`nc -C localhost 1500`
1. Для остановки сервиса можно использовать команду `stop_key`, заданную в параметрах файле конфигурации. Допустим, это команда `stop`, тогда сервис останавливается следующей командой:<br/>
`printf "stop\n"|nc -C localhost 1500`<br/>
После остановке сервис напечатает в файле `calc/bin/inf_<дата запуска>_<время запуска>.txt` строку:<br/>
